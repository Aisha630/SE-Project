...
import { Backdrop, Paper, List, ListItem, ListItemText, IconButton, Fade, Typography, Avatar, Box, Grid, Divider, ThemeProvider } from '@mui/material';
    ...
    return (
        <ThemeProvider theme={theme}>
            <Grid container spacing={1}>
                ...
                <Backdrop open={isOpen} onClick={() => { cartVisibilityToggle(); handleClose() }} style={{ zIndex: 10, color: '#ffffff' }}>
                    <Fade in={cartVisibility}>
                        <Grid item xs={11} sm={11} md={10} lg={5}>
                            <Paper style={{ position: 'relative', borderRadius: 10, padding: md ? 40 : 20, overflow: 'auto', maxHeight: '60vh', backgroundColor: "background.default" }} sx={{backgroundColor: "background.default"}} onClick={e => e.stopPropagation()} >
